...
function downloadTemplate() {
    ...
    const template = '員工ID,員工姓名,日期,班別,上班時間,下班時間,地點,備註\n' +
                    ...
                    'Ue76b65367821240ac26387d2972a5adf,洪培瑜Eric,2026-02-08,廚房H班,18:00,23:00,分公司,\n' +
                    'Ue76b65367821240ac26387d2972a5adf,洪培瑜Eric,2026-02-09,外場B3班,18:00,01:00,總公司,跨日班\n' +
                    'Ue76b65367821240ac26387d2972a5adf,洪培瑜Eric,2026-02-10,排休,00:00,00:00,總公司,休假日';
    
    downloadCSV(template, '排班範本.csv');
    
    console.log('✅ 範本檔案已下載');
    console.log('   共 10 筆測試資料');
    console.log('   包含：廚房班別、外場班別、排休');
    console.log('   格式: 員工ID, 員工姓名, 日期, 班別, 上班時間, 下班時間, 地點, 備註');
    
    showMessage('✅ 範本下載成功！包含 10 筆測試資料，請依照範本格式填寫', 'success');
}
